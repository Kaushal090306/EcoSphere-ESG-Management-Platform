          ...
          return (
            <Card key={c.id} className="flex flex-col justify-between overflow-hidden border border-[#221F2C] hover:border-purple-500/20 transition duration-300">
              <CardHeader className="pb-4">
                ...
                <CardTitle className="text-lg mt-3 text-white">{c.title}</CardTitle>
              ...
              <CardFooter className="pt-2 pb-6 px-6">
                {isApproved ? (
                  ...
                  <Button
                    ...
                    className="w-full bg-purple-600 hover:bg-purple-700 text-white font-semibold flex items-center gap-1.5 justify-center shadow-lg shadow-purple-900/20"
                  >
                  ...
                  <Button
                    ...
                    disabled={loading}
                    className="w-full bg-slate-800 hover:bg-slate-700 text-white border border-[#221F2C] font-semibold flex items-center gap-1.5 justify-center"
                  >
              ...
              {participations
                ...
                .map((p) => (
                  <TableRow key={p.id} className="border-b border-[#221F2C] hover:bg-slate-900/30">
                    <TableCell className="font-medium text-white">{p.employeeName}</TableCell>
                    <TableCell className="text-white">{p.challengeTitle}</TableCell>
                    ...
                    <TableCell className="text-right">
                      <Button
                        ...
                        disabled={loading}
                        className="bg-eco-green hover:bg-emerald-600 text-white font-semibold px-3 py-1 text-xs"
                      >
                        Approve
                      </Button>
                    </TableCell>
        ...
        <DialogContent className="max-w-md">
          <DialogHeader>
            ...
            <DialogDescription className="text-muted-foreground mt-2">
              Please provide evidence for completing <span className="font-semibold text-white">"{selectedChallenge?.title}"</span>.
            </DialogDescription>
          </DialogHeader>
          <form onSubmit={handleEvidenceSubmit} className="space-y-4">
            ...
            <DialogFooter>
              ...
              <Button type="submit" disabled={loading || !proofUrl.trim()} className="bg-purple-600 hover:bg-purple-700 text-white font-semibold">
