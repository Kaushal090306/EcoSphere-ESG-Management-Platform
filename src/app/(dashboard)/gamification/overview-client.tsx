...
export function OverviewClient({
  ...
  return (
    <div className="space-y-6">
      {/* Welcome Banner */}
      <div className="flex flex-col md:flex-row items-stretch md:items-center justify-between gap-6 p-6 bg-gradient-to-br from-[#1C182B] to-[#120E1C] border border-[#2B233D] rounded-2xl relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 bg-slate-950/40 border border-[#2B233D] p-4 rounded-xl relative z-10 w-full md:w-80">
          <div className="flex flex-col items-center justify-center bg-purple-900/30 text-purple-300 border border-purple-500/20 w-16 h-16 rounded-xl flex-shrink-0">
          ...
          <div className="flex-1 space-y-1.5">
            ...
            <div className="h-2 w-full bg-[#181524] rounded-full overflow-hidden">
              <div
                className="h-full bg-[#9B5CF6] transition-all duration-300"
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <Card className="border border-[#221F2C] lg:col-span-1 flex flex-col">
          <CardHeader>
          ...
          <CardContent className="flex-1 overflow-y-auto max-h-[340px] space-y-4">
            {unlockedBadges.length === 0 ? (
              ...
              unlockedBadges.map((badge) => (
                <div key={badge.id} className="flex items-start gap-3 p-3 bg-slate-900/30 border border-[#221F2C] rounded-lg">
        ...
        {/* XP Ledger History */}
        <Card className="border border-[#221F2C] lg:col-span-2">
          <CardHeader>
            <CardTitle className="flex items-center gap-2 text-base text-white">
              ...
              <Table>
                ...
                <TableBody>
                  {recentTransactions.map((tx) => (
                    <TableRow key={tx.id} className="border-b border-[#221F2C] hover:bg-slate-900/20">
        ...
        <CardContent>
          <ResponsiveContainer width="100%" height={260}>
            <BarChart data={chartData}>
              ...
              <Tooltip
                contentStyle={{ backgroundColor: "#181922", border: "1px solid #221F2C", borderRadius: "12px", color: "#ffffff" }}
              />
